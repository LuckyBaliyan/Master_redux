...
*/ const store = (0, _redux.createStore)(reducer); // we must need to pass the reducer int it
...
}); // we have to pass exact same parameters we used inhead of the
...
},{}]},["jmXWr","kTBnD"], "kTBnD", "parcelRequire11c2", {})
